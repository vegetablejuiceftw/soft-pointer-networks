...
class MultiContextAttentionAudio(nn.Module):
    def __init__(
        ...
        self.encoder_audio_initial = LightLSTM(
            embedding_audio_size, vocab_size, with_hidden=True
        ).to(device)
    ...
    def forward(
        ...
        # hidden_size
        encoded_transcriptions, hidden_transcription = self.encoder_transcription(
